...
// configuration step. It creates a namespace called `mychat`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", mychat::cmake::project_name, mychat::cmake::project_version) };
